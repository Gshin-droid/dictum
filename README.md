...
**Голосовая диктовка для Windows.** Нажал клавишу — говоришь — текст появляется
в том окне, где стоял курсор.
...
Скачать `dictum.exe` и запустить. Всё.
...
строка в `logs/dictum.log` рядом с exe скажет, на чём она встала.
