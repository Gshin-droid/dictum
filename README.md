...
📄 **Расшифровка записей.** Бросил на программу аудиофайл — рядом лёг текст.
...
**Перетащил файл, ничего не произошло.** Программа должна быть запущена: значок
у часов на месте. Если её нет, перетаскивание сначала запустит её, и расшифровка
пойдёт через несколько секунд, когда загрузится модель.
