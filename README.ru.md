...
**[2 находки из 69 →](https://www.virustotal.com/gui/file/ce80e37dfef69a5c38567281b9b84f34a82324509848d5b1ce185cb9e287e8bc/detection)**
— Bkav и Microsoft. Kaspersky, ESET, Avast и Dr.Web претензий не имеют.

В версии 1.2.2 находок было три: к этим двум добавлялась Zillya. В 1.3.0 она
успокоилась сама — состав сборки изменился, модуль знаков препинания стал вдвое
легче. **А в 1.1.3 находок было две, и Microsoft среди них не было.** Скрывать
это незачем, но объяснить стоит, потому что причина известна.

Вердикт Microsoft — `Trojan:Win32/Wacatac.C!ml`. Приписка `!ml` означает
