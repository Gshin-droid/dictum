...
**[2 находки из 69 →](https://www.virustotal.com/gui/file/4d2597de594cf19e12a7b83264a14586d16c6584924f61a758be6ec78b36e07a/detection)**
(Bkav и Zillya). Ни Microsoft, ни Kaspersky, ни ESET, ни Avast,
ни Dr.Web к файлу претензий не имеют.

Обе находки — из тех, что малоизвестные движки выдают почти на любую
...
`v1.1.3`, его можно сверить у себя командой в PowerShell:
