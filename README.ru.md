...
Скачать `dictum-portable-kazahskiy.zip` из выпуска с пометкой «Pre-release». То
...
**[2 находки из 69 →](https://www.virustotal.com/gui/file/4b0c3e15742c2f63c607dac6a5d59c63c804b453b3a724f5fa7bdcad4e840555/detection)**
...
Вердикт Microsoft — `Trojan:Win32/Wacatac.B!ml`. Приписка `!ml` означает
...
`v1.3.0` — один и тот же exe лежит и отдельным файлом, и внутри обоих архивов.
