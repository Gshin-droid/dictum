...
# собственный шум усилителя. Замерено на молчащем входе Realtek — пики 0,0014,
# 0,0016, 0,0019, 0,0033, 0,0038 при шести заходах. Речь даёт хотя бы 0,05.
# Берём 0,01: вдесятеро выше измеренного шума и впятеро ниже тихой речи.
# Цена ошибки в обе стороны — только выбор надписи: сюда попадают лишь записи,
# из которых распознавание и так не достало ни слова.
SILENT_PEAK = 0.01
